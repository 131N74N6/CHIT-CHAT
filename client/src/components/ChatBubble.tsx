        ...
        <>
            {props.isSelectMode ? (
                <div className="flex items-center gap-2.5">
                    ...
                    <div 
                        className={cn(
                            ...
                            "font-300 flex flex-col gap-1 p-1 peer-checked:border-blue-500 border-dashed border-blue-500",
                            "rounded-b-sm rounded-l-sm rounded-r-sm"
                        )}
                    >
                        {props.chat.media.length > 0 ? (
                            <div className="w-full h-[5%]">{props.chat.media[0].url}</div>
                        ) : null}
                ...
                <div 
                    className={cn(
                        `${props.own ? "ml-[50%] bg-blue-700 text-white" : "mr-[50%] bg-gray-400 text-gray-900 w-[60%]"}`, 
                        "font-300 flex flex-col gap-1 p-1 rounded-b-sm rounded-l-sm rounded-r-sm"
                    )}
                >
                    {props.chat.media.length > 0 ? (
                        <div className="w-full h-[5%]">{props.chat.media[0].url}</div>
